            ...
            {totalPages > 1 && (
                <div className="flex justify-center items-center gap-2 mt-4" style={{ direction: 'ltr' }}>
                    <button onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page === 1}
                        className="px-3 py-1 rounded border border-[#C3C6D6] dark:border-gray-700 text-[#434654] disabled:opacity-50 hover:bg-[#ecf8fa] dark:bg-gray-900 text-sm">السابق</button>
                    ...
                    <button onClick={() => setPage(p => Math.min(totalPages, p + 1))} disabled={page === totalPages}
                        className="px-3 py-1 rounded border border-[#C3C6D6] dark:border-gray-700 text-[#434654] disabled:opacity-50 hover:bg-[#ecf8fa] dark:bg-gray-900 text-sm">التالي</button>
                </div>
            )}
                        ...
                        <div className="p-6 flex flex-col gap-6">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="text-left">
                                    <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">تاريخ الإرسال</p>
                    ...
                    <form onSubmit={handleSendReply} className="bg-white dark:bg-gray-800 w-full max-w-xl rounded-2xl shadow-xl overflow-hidden flex flex-col">
                        ...
                        <div className="p-6 flex flex-col gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">إلى:</p>
                        ...
                        <div className="p-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-3 bg-gray-50">
                            <button type="button" onClick={() => setIsReplyOpen(false)}
                                className="px-5 py-2 border border-gray-300 rounded-lg text-gray-600 dark:text-gray-400 dark:text-gray-500 font-semibold text-sm hover:bg-gray-100 dark:bg-gray-800 transition-colors">إلغاء</button>
                            <button type="submit"
                                className="bg-[#138C9F] text-white px-6 py-2 rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-[#117a8c] transition-colors">
