  ...
  return (
    <div className="bg-slate-50 dark:bg-gray-900 flex items-center justify-center font-['Cairo']" dir="rtl">
      <div className="w-full h-screen flex flex-row overflow-hidden shadow-xl">
        ...
        <div className="w-full md:w-1/2 h-screen overflow-y-auto p-12 bg-white dark:bg-gray-800">
              ...
              <>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex items-center gap-3 my-1">
                    ...
                    <span className="text-xs font-bold text-slate-400 dark:text-gray-400">{t('login.orContinueWith')}</span>
                    <div className="flex-1 h-px bg-slate-200 dark:bg-gray-600"></div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <button
                      type="button"
                      onClick={() => googleLogin()}
                      className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white font-bold py-3 rounded-xl text-sm transition-all cursor-pointer"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => toast.info('تسجيل بـ Apple قادم قريباً')}
                      className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white font-bold py-3 rounded-xl text-sm transition-all cursor-pointer"
                    >
