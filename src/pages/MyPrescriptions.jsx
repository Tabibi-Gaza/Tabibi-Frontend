                ...
                <div className="fixed -left-[9999px] top-0" dir="rtl">
                    <div ref={printRef} style={{ width: '560px', padding: '25px', fontFamily: 'Tajawal, Arial, sans-serif', background: '#fff', color: '#0B1C30', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, opacity: 0.07, pointerEvents: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', transform: 'rotate(-35deg)' }}>
                            <p style={{ fontSize: '64px', fontWeight: '900', color: '#e03030', margin: 0, fontFamily: 'Tajawal, Arial, sans-serif' }}>{selectedRx.clinicName || 'عيادة طبيبي'}</p>
                        </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', padding: '10px', background: '#f8fafb', borderRadius: '10px', position: 'relative', zIndex: 1 }}>
                            ...
                            <div style={{ textAlign: 'left' }}>
                                ...
                                {selectedRx.sentAt && <p style={{ fontSize: '10px', color: '#666', margin: 0 }}>{formatTimeArabic(selectedRx.sentAt)}</p>}
                            </div>
                        </div>
