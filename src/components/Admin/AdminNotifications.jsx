        ...
        <main className="w-full min-h-screen bg-[#ecf8fa] dark:bg-gray-900 p-4 md:p-10" dir="rtl">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 border border-[#C3C6D6] dark:border-gray-700 rounded-2xl p-6 md:p-8 shadow-xs flex flex-col items-center justify-center text-center gap-3 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#0B1C30] dark:text-gray-200">مركز الإشعارات والتنبيهات</h1>
                    <p className="text-sm text-[#526069] dark:text-gray-400">تابع أحدث الأنشطة، عمليات الحجز، والتحديثات الواردة للنظام.</p>
                </div>
                            ...
                            >
                                <div className="flex-1 text-right">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h3 className="text-base font-bold text-[#0B1C30] dark:text-gray-200">
