    ...
    <section className="bg-white py-20 md:py-28" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          <span className="text-xs font-black text-[#138C9F] bg-[#138C9F]/10 px-4 py-2 rounded-full inline-block tracking-wide font-['Cairo'] mb-5">
            مميزات طبيبي
          </span>
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-slate-900 font-['Cairo'] leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
          {features.map((feature, i) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="text-xl md:text-2xl font-black text-slate-900 mb-3 font-['Cairo']">
                {feature.title}
              </h3>
              <p className="text-slate-500 leading-relaxed font-bold text-sm md:text-base font-['Cairo']">
                {feature.desc}
              </p>
            </div>
          ))}
