...
const RelatedDoctors = ({ speciality, docId }) => {
    ...
    return (
        <div className='flex flex-col items-center gap-3 my-12 text-gray-900 text-right' dir='rtl'>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 pt-2 px-2 sm:px-0'>
                {relDocs.slice(0, 4).map((item, index) => (
                    ...
                    >
                        ...
                        <div className='relative bg-[#f4faff] pt-4 flex justify-center h-48 overflow-hidden'>
                            ...
                            <img loading="lazy" decoding="async" width="200" height="192" className='h-full object-contain' src={item.image} alt={item.name} />
                        </div>
                        ...
                        <div className='p-4 flex-1 flex flex-col justify-between'>
                            ...
                            <button className='w-full mt-4 bg-[#138c9f] hover:bg-[#138c9f] text-white py-2 rounded-xl font-medium text-xs transition-colors duration-200 shadow-sm'>
                                احجز الآن
                            </button>
                        </div>
                    </div>
